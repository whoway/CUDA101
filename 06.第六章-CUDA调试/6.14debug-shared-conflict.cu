...
int main(int argc, char **argv)
{
    ...
    cudaMalloc((void **)&d_input_values, N * sizeof(int));
    ...
    for (i = 0; i < runs; i++)
    {
        ...
        cudaMemcpy(d_input_values, h_input_values, N * sizeof(int),
        ...
        mean_time += GetCPUSecond() - start;
        cudaMemcpy(&h_sum, d_shared_var, sizeof(int),
