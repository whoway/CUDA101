...
__global__ void sumMatrixOnGPU2DGrid1Dblock(float *MatA, float *MatB, float *MatC, int nx,int ny)
{
...
int main(int argc, char **argv)
{
    ...
    sumMatrixOnGPU2DGrid1Dblock<<<grid, block>>>(d_MatA, d_MatB, d_MatC, nx, ny);
